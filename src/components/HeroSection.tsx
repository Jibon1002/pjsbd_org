const HeroSection = () => {
  ...
  return (
    <section id="home" className="relative min-h-[70vh] md:min-h-screen flex items-center justify-center overflow-hidden pt-10 md:pt-16">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute bottom-1/4 left-[15%] w-2 h-2 bg-white/30 rounded-full animate-float" style={{ animationDuration: '4s' }} />
        <div className="absolute bottom-1/3 left-[25%] w-1.5 h-1.5 bg-white/20 rounded-full animate-float" style={{ animationDuration: '5s', animationDelay: '1s' }} />
        <div className="absolute bottom-1/2 right-[20%] w-2.5 h-2.5 bg-white/25 rounded-full animate-float" style={{ animationDuration: '6s', animationDelay: '2s' }} />
        <div className="absolute bottom-[40%] right-[30%] w-1 h-1 bg-white/35 rounded-full animate-float" style={{ animationDuration: '4.5s', animationDelay: '0.5s' }} />
        <div className="absolute bottom-[60%] left-[40%] w-1.5 h-1.5 bg-white/15 rounded-full animate-float" style={{ animationDuration: '5.5s', animationDelay: '1.5s' }} />
      </div>
