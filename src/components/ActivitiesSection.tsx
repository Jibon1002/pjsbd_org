...
const ActivitiesSection = () => {
  const activities = [{
    icon: BookOpen,
    title: "শিক্ষা",
    description: "বিনামূল্যে শিক্ষা ও বই বিতরণ",
    color: "bg-blue-500/10 text-blue-600"
  }, {
    icon: Heart,
    title: "স্বাস্থ্য",
    description: "স্বাস্থ্য ক্যাম্প ও রক্তদান",
    color: "bg-red-500/10 text-red-600"
  }, {
    icon: Leaf,
    title: "পরিবেশ",
    description: "বৃক্ষরোপণ ও পরিচ্ছন্নতা",
    color: "bg-green-500/10 text-green-600"
  }, {
    icon: Users,
    title: "যুব উন্নয়ন",
    description: "দক্ষতা ও নেতৃত্ব প্রশিক্ষণ",
    color: "bg-purple-500/10 text-purple-600"
  }, {
    icon: GraduationCap,
    title: "বৃত্তি",
    description: "মেধাবী শিক্ষার্থীদের সহায়তা",
    color: "bg-amber-500/10 text-amber-600"
  }, {
    icon: Droplets,
    title: "দুর্যোগ ত্রাণ",
    description: "ত্রাণ সামগ্রী বিতরণ",
    color: "bg-cyan-500/10 text-cyan-600"
  }];
  return <section id="activities" className="py-12 md:py-20 bg-secondary/30">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-3 md:gap-4">
          {activities.map((activity, index) => <div key={index} className="group p-4 md:p-5 bg-card rounded-xl shadow-soft hover:shadow-elevated transition-all duration-300 overflow-hidden">
